import 'package:Baytotee/src/elements/SearchBarWidget.dart';
import 'package:Baytotee/src/pages/messages.dart';
import 'package:Baytotee/src/pages/notifications.dart';
import 'package:Baytotee/src/pages/privacy.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/DeliveryAddresses':
        ...
        // case '/ContinueOrder':
        // return MaterialPageRoute(builder: (_) => ContinueOrder());
      case '/DeliveryPickup':
      ...
      case '/privacy':
        return MaterialPageRoute(builder: (_) => PrivacyWidget());
        case '/Notification':
