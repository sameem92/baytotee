                  ...
                  children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              widget.cart.product.discountPrice > 0
                                  ? Helper.getPrice(
                                  widget.cart.product.discountPrice, context,
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(widget.cart.quantity.toString(), style: Theme.of(context).textTheme.subtitle1.merge(TextStyle(color: Theme.of(context).accentColor))),
                        IconButton(
                          onPressed: () {
                            setState(() {
                              widget.decrement();
